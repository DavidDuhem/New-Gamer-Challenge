...
export default function ChallengeList() {
	const [currentDisplayMode, setCurrentDisplayMode] = useState<ChallengeDisplayList>(
		ChallengeDisplayList.LIST
	);
					...
					<div className="hidden md:flex gap-2">
						<button
							...
							className={`btn btn-primary ${
								currentDisplayMode === ChallengeDisplayList.LIST ? 'btn-active' : ''
							}`}
						...
						<button
							type="button"
							className={`btn btn-primary ${
								currentDisplayMode === ChallengeDisplayList.GRID ? 'btn-active' : ''
							}`}
